//! SPARTA SAF VBAP (Vector-Based Amplitude Panning) wrapper
//!
//! This module provides a safe Rust wrapper around the SPARTA Spatial Audio Framework's
//! VBAP implementation. VBAP is the academic standard for spatial audio panning
//! (Pulkki 1997).
//!
//! Features:
...
// SPARTA SAF bindings - only available with "sparta" feature
